...
Процедура ПередНачаломРаботыСистемы()
	...
	Если МедПредыСервер.ЭтоЗаказчик() Тогда
...
Процедура ПриНачалеРаботыСистемы()
	...
	Если МедПредыСервер.ЭтоЗаказчик() Тогда
		ФормаПараметры = Новый Структура("ПутьКПодсистеме", "МедПреды");
		ОткрытьФорму("ОбщаяФорма.ПанельОтчетов", ФормаПараметры, , "МедПреды");
	КонецЕсли;
